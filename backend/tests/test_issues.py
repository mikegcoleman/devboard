...
def test_search_returns_200_when_implemented(client, auth_headers, project):
    """Search endpoint returns 200 now that the TODO is completed."""
    resp = client.get(
...
def test_search_finds_matching_issues(client, auth_headers, project):
    """
    Search endpoint returns issues whose title or description contains the query.
    """
